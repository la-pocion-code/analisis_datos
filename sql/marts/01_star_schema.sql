...
CREATE TABLE IF NOT EXISTS marts.dim_cuenta (
    ...
    -- Nombres de la jerarquía PUC (account.group, es_CO; ver 13_puc_nombres.sql)
    clase_nombre     TEXT,                   -- N1: INGRESO/GASTOS/ACTIVO…
    grupo_nombre     TEXT,                   -- N2: OPERACIONALES, CUENTAS POR COBRAR…
    cuenta_nombre    TEXT,                   -- N4: CLIENTES, GASTOS DE PERSONAL…
    subcuenta_nombre TEXT,                   -- N6: NACIONALES, … SALARIOS…
    seccion          TEXT,                   -- raíz del reporte: ACTIVOS/PASIVO/PATRIMONIO/Ingresos/Gastos/Costos…
    concepto         TEXT,                   -- intermedio (padre del leaf): Gastos, Activos corrientes, PATRIMONIO…
    nivel_movimiento TEXT,                   -- DETALLE/hoja para el PyG: Operacionales de administración, Deudores…
